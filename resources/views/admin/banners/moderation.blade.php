...
<x-app-layout>
    ...
    {{ Breadcrumbs::render('admin.banners.moderation.index') }}
    <div class="py-12">
            ...
            @forelse ($banners as $banner)
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6" x-data="{ rejecting: false }">
                    ...
                    <div class="mt-4 pt-4 border-t flex items-center gap-3">
                        <form method="POST" action="{{ route('admin.banners.moderation.approve', $banner) }}"
                    ...
                    <form x-show="rejecting" method="POST"
                          action="{{ route('admin.banners.moderation.reject', $banner) }}"
