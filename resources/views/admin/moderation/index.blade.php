            ...
            @forelse ($adverts as $advert)
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6" x-data="{ rejecting: false }">
                    ...
                    <div class="mt-4 pt-4 border-t flex items-center gap-3">
                        <form method="POST" action="{{ route('admin.moderation.approve', $advert) }}" class="flex items-center gap-2">
                            @csrf
                    ...
                    <form x-show="rejecting" method="POST" action="{{ route('admin.moderation.reject', $advert) }}" class="mt-3 flex items-center gap-2">
                        @csrf
